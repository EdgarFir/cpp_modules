...
AForm::CreateFormException::CreateFormException(const std::string & msg) throw() {
    _msg = msg;
}

AForm::CreateFormException::~CreateFormException() throw() {}
 ...
 * @return Exception message.
 */
const char * AForm::CreateFormException::what() const throw() {
    return _msg.c_str();
}
