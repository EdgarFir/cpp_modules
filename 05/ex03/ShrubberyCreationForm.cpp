...
/**
 * @brief Create a new allocated Shrubbery form.
 * 
 * @param target Name of the target.
 * 
 * @returns new ShrubberyCreationForm initialized with target.
*/
AForm       *ShrubberyCreationForm::createShrubbery(const std::string & target) {
